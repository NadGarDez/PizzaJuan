...
export const LOGIN_BUTTON_TEXT:string= "Iniciar Sesion";
export const ADD_NEW_ADDRESS_TEXT:string= "Agregar nueva direccion";
export const SAVE_ADDRESS_TEXT:string= "Guardar direccion";
export const CANCEL_TEXT:string= "Cancelar";
