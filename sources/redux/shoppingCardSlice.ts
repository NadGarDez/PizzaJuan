...
const shoppingCardSlice = createSlice(
    {
        ...
        reducers: {
            setProduct: (
                ...
                if (state.products[action.payload.key] !== undefined) {
                    const oldAmount = state.products[action.payload.key].numberOfItems;
                    state.products[action.payload.key].numberOfItems = oldAmount + action.payload.item.numberOfItems

                    console.log(state.products[action.payload.key].numberOfItems)
                } else {
